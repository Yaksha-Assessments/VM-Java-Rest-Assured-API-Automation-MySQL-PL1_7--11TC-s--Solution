...
//	}
	...
	public CustomResponse(Response response, int statusCode, String status, List<Object> id, List<Object> fieldName, List<Object> fieldType, List<Object> extraData, List<Object>screen) {
		this.response = response;
		this.statusCode = statusCode;
		this.status = status;
		this.id = id;
...
//	}
	...
	public CustomResponse(Response response, int statusCode, String status, List<Object> employeeNumbers,
			List<Object> lastNames, List<Object> firstNames, List<Object> employeeIds) {
		this.response = response;
		this.statusCode = statusCode;
		this.status = status;
	...
	public CustomResponse(Response response, int statusCode, String status, List<Object> enable,  List<Object> hostname, List<Object> port, List<Object> encryption, List<Object> ldapImplementation,List<Object> bindAnonymously, List<Object> bindUserDN, List<Object> hasBindUserPassword, List<Object> userLookupSettings, List<Object>dataMapping, List<Object> mergeLDAPUsersWithExistingSystemUsers, List<Object> syncInterval) {
		this.response = response;
		this.statusCode = statusCode;
		this.status = status;
		this.enable = enable;
		...
		this.userLookupSettings = userLookupSettings;
